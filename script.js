...
class Workout {
  date = new Date(); //to call a class, create an instance of it  by using new keywork and passing the required parameters and then call the method on the instance of the parent class
...
class Running extends Workout {
  ...
  constructor(coords, distance, duration, cadence) {
    ...
    // used to initialize the property inherited from the parent class
